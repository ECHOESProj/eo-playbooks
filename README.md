...
## Ignore your private files

Make Git ignore `group_vars/all` and `hosts`,
incase you do not want to commit them to the repository.

        git update-index --assume-unchanged group_vars/all
